...
module OpenXrefManager
  ...
  def self._is_update_available?(definition)
    return false unless self.is_xref?(definition)
  ...
  def self.show_manager_dialog
    ...
    @dialog.add_action_callback("reload_single_clicked") { |ctx, name, suppress_warning| self.reload_single_xref(name, suppress_warning: suppress_warning) }
